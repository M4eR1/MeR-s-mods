...
Gui, Add, Text, x10 y5 w180 h30 Center BackgroundTrans cFFA500 gGuiMove, 🎮 MeR's Aim Assistant
...
Gui, Add, Button, w180 h28 gLegit, 🕶️ Legit

Gui, Add, Text, y+10 w180 Center c00CED1, 🛠️ Modes
...
Gui, Add, Button, x+10 w125 h26 gChestButton, 🛡️ Chest
...
Gui, Add, Text, y+10 w180 Center c00CED1, ⚙️ Other
Gui, Add, CheckBox, vRedBoxToggle, 🟥 Show Red Square Overlay
Gui, Add, CheckBox, vRapidFireToggle, ⚡ Rapid Fire
Gui, Add, CheckBox, vAutoMarkToggle, 🏷️ Auto Mark (MB1+MB2 → P)
Gui, Add, CheckBox, vYYToggle, 🔁 YY (Hold 1)

Gui, Add, Button, x10 y+20 w50 h28 gClose, ❌

Gui, Show, AutoSize, Aimbot GUI
AnimateGuiIn()
...
~LButton::
    ...
    if (InStr(title, "MeR's Aim Assistant"))
